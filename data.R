...
st_write(units, "data/units.csv", append = FALSE)
st_write(units, "data/units.shp", append = FALSE)
st_write(unitgrids, "data/unitgrids.csv", append = FALSE)
st_write(unitgrids, "data/unitgrids.shp", append = FALSE)
